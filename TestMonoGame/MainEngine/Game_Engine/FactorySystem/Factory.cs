...
{
    private static readonly Transform _rootTransform = MainGameEngine.RootTransform;
    ...
    public static GameObject Instantiate<T>(Vector2 position, Transform parent, Vector2 scale)
